...
public class EasyCarMain {
	...
	public static void main(String[] args) {
		...
		Truck truck1 = new Truck("Mercedes", "Van mercedes", "Gris", LocalDate.of(2025, 5, 5), 150.20, FuelType.DIESEL,
				150, false, 8);
		Skate skate1 = new Skate("Magenta", "Big plant", "Multi-color", LocalDate.of(2024, 1, 2), 20, 8.3);
		Car car2 = new Car("Tesla", "Model S", "Blanche", LocalDate.of(2023, 5, 8), 200.0, FuelType.ELECTRIC, 120,
				false, 8);
		...
		Serializer.deserializeCustomer();
	}
